...
export interface SearchRelevancePluginDependencies {
...
export class SearchRelevancePlugin
  ...
  public setup(core: CoreSetup, {dataSourceManagement}: SearchRelevancePluginDependencies): SearchRelevancePluginSetup {
